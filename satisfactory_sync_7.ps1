...
$scriptblock = ({
    ...
    [System.Reflection.Assembly]::LoadWithPartialName('System.Drawing')    | out-null
    [System.Reflection.Assembly]::LoadWithPartialName('WindowsFormsIntegration') | out-null
    #$GameFolder = "76561198343856803" #DEIN GAME ORDNER HIER EINTRAGEN. Hier findest du den entsprechenden Game Ordner: C:\Users\[Dein 
    Name]\AppData\Local\FactoryGame\Saved\SaveGames
    $sync_error = 0
    Function Show-MessageForm {
        ...
        $Coordinates                     = switch ($Poistion)
        {
            ...
            'RightBottom' { $([System.Windows.Forms.Screen]::PrimaryScreen.WorkingArea.Width - $Form.Width), 
    $([System.Windows.Forms.Screen]::PrimaryScreen.WorkingArea.Bottom + $Form.height) }
        }
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUHw0YbJuImvqRgVrDx8WJV21N
# G56gghYkMIIDGTCCAgGgAwIBAgIQexbogPXeboFOAZHih7e5LjANBgkqhkiG9w0B
...
# AQsxDjAMBgorBgEEAYI3AgEVMCMGCSqGSIb3DQEJBDEWBBR4gEMzhBQ9+kZLch1e
# 2XRNU3PEDDANBgkqhkiG9w0BAQEFAASCAQANGffyHcIgBD99ETZyG8fv+Zw7gY7N
# q+ZstId+i7YhzM5IDhsp+7bmDURx/Lo9nCezMDGCDWMlAkS9UhN1xgpOezPr7Mw4
# bO1Qctm8cR9ZElZ9wWzb3MxFkL5YSUnHZ6GqSD594E0WSkSz1uhJwZ3ie1EDAMHr
# 0hQNUUmCmCqTWVuIRmeBFupqKmeFco0gA2l7ZHx7kF7JpiR1XiuyvD+sNtuqupQz
# iu2RoCFR05Aue9g2zttkZRK7Vm0AbVwqhboVW0uhv6LSYVU4FP5FWYmyputdtwdw
# j/7GBmutj/Vu+ZJjVv1W+ltGNMYVZTLFg2uKeEwjfU8jfSiRbUupDZc1oYIDIDCC
...
# KoZIhvcNAQkFMQ8XDTIzMDUxMTE5MDg1OFowLwYJKoZIhvcNAQkEMSIEIDvN1p7J
# zXeCW7uFfK3qVIbO9G8OehMt/lsIVx9H1a8OMA0GCSqGSIb3DQEBAQUABIICAHwh
# TdkVAhO2hFvJ8UB3VsrBQdTSxvvBqTADRbA9M/Nyh8jf8/iSjgTKfK41mB37HaKa
# nM1zkJv/DBMFuio3lzZD2b4mcq1WZNj1oPVYrmIkcj1EOYeOvzlmBC282MWwcvLC
# HXEt3jXjsuLMcEHHk3iVKQPHlmHJXf6Yl/R/BlcAcVx6U0zi0juVffR8A6PW4HnG
# qyln0bwdWyu0z4edYpIBkgp+uXnTsnFZ5Mh7g5nSlfb1jibUcT6bRe+6PhVgFZVS
# I8fG1xxhCXPsAAYHNw5TxLTx717IfT4xt4WESUdgqQ+1EythFO+eVlCC7tbvTjPQ
# NvlIQXUeRu8AtbQ0imeLw2vWJv3nlcupaCXiAxCL2ohMJCKSxTmxbq+4kZFYSJ2K
# gKBGyRHNPPzYAnwXDRVcr+gaHXKt8LS77w6v1AWX85LQDQEp3FOdtYD99Q4Fl3Zp
# 1Xw2ZBbO5K1LMFodZ5gczJVXUkpsx97bXNC1I8WFALsR1KLQW2yfX47a7IDuPjcS
# HdErBVRzcsC8A93qwg2fflKv6hc0MShmdLOUokZCI8A2E8SeXVLggiPZkUFnsPr2
# 1xLC8t8fPCi+QZ08h/IUDHABWjPf4TiRLDuOviT0J+ShhZvZidGEN2RIGUmBVl/k
# BjP9fIIYe8CWv79JzvVDS1fD5c/ZjVW3YQSHOQdm
